  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1>
          ข้อมูล ลำดับโรคผู้ป่วยในแยกตามหอผู้ป่วย TOP 10 Diag IPD Ward
        </h1>
      </section>
          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header">
                <h3 class="box-title">
                  <div class="container">
                    <form class="form-inline" method="POST" action="top10ward_ipd.php">
        ...
        if($datepickers != "--") {
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title co_dep"><?php echo "หอผู้ป่วย".$row_dep['name']." ข้อมูลช่วงวันที่ ".thaiDatefull($datepickers)." ถึงวันที่ ".thaiDatefull($datepickert) ?> 
