...
<div class="container-fluid main">
  <div class="row">
    <div class="col-lg-8">DDDDDD</div>
    <div class="col-lg-2">AAAAA</div>
     <div class="col-lg-2">VVVV</div>
      ...
      <?php
          ...
          ?>
    <div class="col-lg-8"><?php echo $kpicode."  ".$kpiname;?></div>
    <div class="col-lg-2">ssss</div>
      ...
      /*  $rw == 0;
        foreach ($result as $item) {
          ...
          */
          ...
          <li class=""  data-toggle="modal" data-target="#<?php// echo $kpicode;?>"><span><?php// echo $kpicode."  ".$kpiname;?></span></li>
