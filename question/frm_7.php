...
if ((isset($_POST['sex']) == "" || isset($_POST['sex']) == null || isset($_POST['age']) == "" || isset($_POST['age']) == null || isset($_POST['quser']) == "" || isset($_POST['quser']) == null
    || isset($_POST['q1']) == "" || isset($_POST['q1']) == null || isset($_POST['q2']) == "" || isset($_POST['q2']) == null || isset($_POST['q3']) == "" || isset($_POST['q3']) == null)) {
...
<body>
    ...
    <form action="frm_8.php" method="POST" id="form1">
        ...
        <section>
            ...
            <div class="container">
                <h2 class="detail color4">4.ท่านสามารถนำระบบสารสนเทศไปใช้ให้เกิดประโยชน์แก่หน่วยงานได้เพียงใด</h2>
                <button type="submit" id="q41" name="q4" value="5" class="btn btn-outline-success btn-block" onClick="document.forms['form1'].submit()">มากที่สุด</button>
                <button type="submit" id="q42" name="q4" value="4" class="btn btn-outline-info btn-block" onClick="document.forms['form1'].submit()">มาก</button>
                <button type="submit" id="q43" name="q4" value="3" class="btn btn-outline-warning btn-block" onClick="document.forms['form1'].submit()">ปานกลาง</button>
                <button type="submit" id="q44" name="q4" value="2" class="btn btn-outline-danger btn-block" onClick="document.forms['form1'].submit()">น้อย</button>
                <button type="submit" id="q45" name="q4" value="1" class="btn btn-outline-dark btn-block" onClick="document.forms['form1'].submit()">น้อยที่สุด</button>
            </div>
        </section>
    </form>
</body>
