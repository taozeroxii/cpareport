...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-2">
            วันที่เริ่ม <input name="stdate" type="date"  class="form-control"  value="2022-02-01" id="stdate" placeholder=""  required/>
            </div>
            <div class="col-sm-2">
            วันที่สิ้นสุด <input name="endate" type="date" class="form-control" id="endate" value="2022-02-28" placeholder=""  required/>
            </div>
