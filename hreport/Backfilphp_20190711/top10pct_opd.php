  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1>
          ข้อมูล ลำดับโรคผู้ป่วยนอกแยกตามแผนก TOP 10 Diag OPD Depament 
        </h1>
      </section>
          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header">
                <h3 class="box-title">
                  <div class="container">
                    <form class="form-inline" method="POST" action="top10pct_opd.php">
                      ...
                      <select class="select2" name="pct_dropdown" id="pct_dropdown"  style="width: 30%;" >
                        <option value="" selected>-โปรดเลือก แผนก-</option>
                      </select>
