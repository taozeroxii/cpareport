...
header("Content-Disposition: attachment; filename=expoet_sip09_ipd_".$todate.".xls");
?>
<!DOCTYPE html>
<html>
...
$sql = " SELECT i.regdate,i.regtime,i.dchdate,i.dchtime,a.admdate
,p.cid,p.hn,i.an,      
...
<table border="1">
  ...
  <tbody>
    <? $rw=0; while($row_result = pg_fetch_array($result)){ $rw++; ?>
      <tr>
        <td><?php echo $rw; ?></td>
