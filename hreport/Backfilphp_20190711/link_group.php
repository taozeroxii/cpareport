...
<?php include "config/menuleft.class.php"; ?>
 ...
 <section class="content">
      <div class="row">
        ...
        <div class="col-md-6">
              <a href="https://www.nhso.go.th/FrontEnd/Index.aspx" class="btn btn-app" target="_blank">
                <span class="hhh"> <i class="glyphicon glyphicon-hand-right">  </i> สำนักงานหลักประกันสุขภาพแห่งชาติ (สปสช.)</span>
              </a>                                                                                                
        </div>
    </div>  
