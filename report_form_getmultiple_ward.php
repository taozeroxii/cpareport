...
<body class="hold-transition skin-blue sidebar-mini">
		...
		<div class="content-wrapper">
			...
			<section class="content">
								...
								<h3 class="box-title">
									<div class="container">
										<form class="form-inline" method="POST" action="#">
											...
											<button type="submit" class="btn btn-default">Submit</button> <small style="color: white;">   ** หากไม่เลือกจะแสดงทุกward **</small> 
										</form>
									</div>
								</h3>
							</div>
				...
				if($datepickers != "--") {
					...
					if(sizeof($ward_dropdown )>0){
						$sum_pttypes = "(";
						foreach ($ward_dropdown as $value) {
							 $sum_pttypes .="'" .$value. "',";
						}
			 		...
			 		$sql = str_replace("{multiward_dropdown}", "$sum_pttypes", $sql);
	...
	<script type="text/javascript">
		...
		{
			document.location = "export_excel_f001.php?send_excel=<?php echo $send_excel; ?>&datepickers=<?php echo $datepickers; ?>&datepickert=<?php echo $datepickert; ?>&multiward_dropdown=<?php echo $sum_pttypes;?>";
		}
	</script>
