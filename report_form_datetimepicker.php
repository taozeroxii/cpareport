...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<script type="text/javascript">
		...
		{
			document.location = "export_excel_f001.php?send_excel=<?php echo $send_excel; ?>&datepickers=<?php echo $datepickers; ?>&datepickert=<?php echo $datepickert; ?>&timeindrug=<?php echo $time_in; ?>&timeoutdrug=<?php echo $time_out; ?>";
		}
	</script>
