				...
				<div class="header-right w3agile">
					<div class="header-left-bottom agileinfo">
                        ...
                        <div class="icon1">
                                ...
                                <div class="row">
                                    <div class="col-6">   <input class="form-control"  type="text" placeholder="ชื่อ" name="fullname" required=""/></div>
                                    <div class="col-6">   <input class="form-control" type="text" placeholder="นามสกุล" name="fullname" =""/></div>
                                </div>
                            </div>
                            ...
                            <div class="icon1">
								<i class="fa fa-user" aria-hidden="true"></i>
								<input  type="text" placeholder="password" name="fullname" required=""/>
                            </div>
