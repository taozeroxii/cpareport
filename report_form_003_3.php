...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content">
				...
				if ($datepickers != "--") {
					...
					$NAMEspclty = " SELECT * FROM spclty WHERE spclty = '" .$pct_dropdown. "'";
					$resspclty = pg_query($conn,$NAMEspclty);
					$resSpclty = pg_fetch_array($resspclty);
					?>
					<div class="row">
						<div class="col-xs-12">
							<div class="box">
								<div class="box-header">
									<h3 class="box-title co_dep"><?php echo "แผนก: " .$resSpclty['name']  . "<br> ข้อมูลช่วงวันที่ " . thaiDatefull($datepickers) . " ถึงวันที่ " . thaiDatefull($datepickert) ?>
		...
		<script type="text/javascript">
			...
			//	{
			//		document.location = "export_excel_f002.php?c_department=<? php // echo $c_department; 
																				?>&c_pttype=<?php //echo $c_pttype; 
																							?>&send_excel=<?php //echo $send_excel; 
																																		?>//&datepickers=<?php //echo $datepickers; 
																																												?>&datepickert=<?php //echo $datepickert; 
																																																						?>";
			//	}
		</script>
