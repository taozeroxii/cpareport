<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            var shownIds = new Array();
            setInterval(function() {
                $.get("sql_rt/realtime_age15.php", function(data) {
                    data = $.parseJSON(data);
                    $("#realtime_age15").html("<span class='rt'>" + data + "</span>");
                });
            }, 1000);
        });
        ...
        $(document).ready(function() {
            var shownIds = new Array();
            setInterval(function() {
                $.get("sql_rt/realtime_age30.php", function(data) {
                    data = $.parseJSON(data);
                    $("#realtime_age30").html("<span class='rt'>" + data + "</span>");
                });
            }, 1000);
        });
        ...
        $(document).ready(function() {
            var shownIds = new Array();
            setInterval(function() {
                $.get("sql_rt/realtime_age50.php", function(data) {
                    data = $.parseJSON(data);
                    $("#realtime_age50").html("<span class='rt'>" + data + "</span>");
                });
            }, 1000);
        });
