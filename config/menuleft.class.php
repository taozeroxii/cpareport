...
if (isset($_SESSION['username']) != "" || isset($_SESSION['username']) != null) {
  ...
  $checkactivein15minut = "select username from useronline where  time_online > '$timecheck' AND STATUS = 'online' GROUP BY username";
    ...
    <nav class="navbar navbar-inverse ">
      <div class="container-fluid">
        <div class="navbar-header ">
          ...
          <? //echo $insertlog.' '.$ud;
          ?>
            <a style="   color: yellow;text-shadow: -1px 0 black, 0 1px black, 1px 0 black, 0 -1px black;" href="http://172.16.0.251:81/cpareport/" class="sidebar-toggle" role="button">  Report ตัวทดสอบเวอร์ชั่นใหม่ คลิ๊ก !!</a>
        </div>
