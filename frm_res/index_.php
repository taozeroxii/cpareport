                ...
                <div class="form-group has-success">
                  <div class="row">
                    ...
                    <div class="col-sm-4">
                      ...
                      <input class="form-control" type="text" placeholder="ชื่อสกุลภาษาอังกฤษ" pattern="^[a-zA-Z\s]+$" name="engfullname" onkeypress="return (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode >= 48 && event.charCode <= 57)"  required>
                    </div>
                  </div>
