...
<body class="hold-transition skin-blue sidebar-mini">
				...
				if($datepickers != "--") {
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="box">
								<div class="box-header">
									<h3 class="box-title co_dep"><?php echo " ข้อมูลวันที่ ".thaiDatefull($datepickers)?> 
	...
	<script type="text/javascript">
		...
		{
			document.location = "export_excel_f001.php?send_excel=<?php echo $send_excel; ?>&datepickers=<?php echo $datepickers; ?>";
		}
	</script>
