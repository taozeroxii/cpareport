...
<body class="hold-transition skin-blue sidebar-mini">
		...
		<div class="content-wrapper">
			...
			<section class="content">
								...
								<h3 class="box-title">
									<div class="container">
										<form class="form-inline" method="POST" action="#">
											...
											<select class="select2" name="pct_dropdown[]" id="pct_dropdown" multiple="multiple" style="width: 20%;" placeholder="สิทธิ" title="เลือกสิทธิ์"></select>
											<button type="submit" class="btn btn-default">Submit</button> <small style="color: white;">   ** หากไม่เลือกจะแสดงทุกแผนก **</small> 
										</form>
									</div>
								</h3>
							</div>
                ...
                $multiplespclty_dropdown   = $_POST['pct_dropdown'];   
				...
				if($datepickers != "--") {
					...
					if(sizeof($multiplespclty_dropdown )>0){
						$sum_pttypes = "(";
						foreach ($multiplespclty_dropdown as $value) {
							 $sum_pttypes .="'" .$value. "',";
						}
			 		...
			 		$sql = str_replace("{multiplespclty_dropdown}", "$sum_pttypes", $sql);
	...
	<script type="text/javascript">
		...
		{
			document.location = "export_excel_f001.php?send_excel=<?php echo $send_excel; ?>&datepickers=<?php echo $datepickers; ?>&datepickert=<?php echo $datepickert; ?>&multiplespclty_dropdown=<?php echo $sum_pttypes;?>";
		}
	</script>
