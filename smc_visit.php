  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1>
          สถิติข้อมูลการรับบริการ คลินิกเฉพาะทางนอกเวลา SMC
        </h1>
      </section>
          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header">
                <h3 class="box-title">
                  <div class="container">
                    <form class="form-inline" method="POST" action="smc_visit.php">
...
*/
        if($datepickers != "--") {
          ...
          INNER JOIN kskdepartment as k ON k.depcode = o.main_dep AND department LIKE '%%SMC%%'
