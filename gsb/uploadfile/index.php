...
<form id="uploadForm" action="upload.php" method="post">
	<div>
		<label class="gg">Upload Excel File เลือกไฟล์นำเข้า :</label>
		<input name="userImage" id="userImage" type="file" class="demoInputBox" />
	</div>
	<div class="bb"><input type="submit" id="btnSubmit" value="นำไฟล์เข้าระบบ" class="btnSubmit" /></div>
	<div id="progress-div">
...
<div class="yy">นำไฟล์เข้าระบบแล้ว Upload ไฟล์ 100% แล้วกลับไป Import File Excel เข้าฐานข้อมูล </div>
<hr>
<div class="bb">
	<a href="../index.php">
		<input type="" id="" value="กลับไปหน้าหลัก" class="btnSubmit" />
	</a>
</div>