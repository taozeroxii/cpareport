		...
		<div class="content-wrapper">
			...
			<section class="content">
								...
								<h3 class="box-title">
									<div class="container">
										<form class="form-inline" method="POST" action="#">
											...
											&nbsp;&nbsp;
											<input type="text" class="form-control" id="number_start" name="number_start" placeholder="จำนวนครั้งระหว่าง" title=" ถ้าต้องการหาจำนวนครั้ง แค่ ครั้งเดียวให้ใส่ค่าเหมือนกันทั้ง 2 ช่วง " >
											<input type="text" class="form-control" id="number_end" name="number_end" placeholder="จำนวนครั้งถึง" title=" ถ้าต้องการหาจำนวนครั้ง แค่ ครั้งเดียวให้ใส่ค่าเหมือนกันทั้ง 2 ช่วง">
				...
				if($datepickers != "--") {
					...
					$sql = str_replace("{number_start}", "'$number_start'", $sql);
					$sql = str_replace("{number_end}", "'$number_end'", $sql);
					$result = pg_query($sql);
					?>
					<div class="row">
						<div class="col-xs-12">
