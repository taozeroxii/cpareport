...
$subItems = " SELECT * FROM drug_due WHERE status_frm = 'Y' ORDER BY id ASC ";
    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="page-heading">
                <h4>แบบฟอร์มการประเมินการใช้ยา Drug Use Evaluation (DUE)</h4>
            </div>
                    ...
                    <div class="row">
                        ...
                        ?>
                            <div class="col-6 col-lg-6 col-md-6">
                                <a href="<? echo "frmdrug_due/".$frm_drug."".$file_drug; ?>" target="_blank" rel="">
                                    <div class="card">
