  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1>
          ตัวชีวัด >  อัตรารับกลับเข้า รพ.ของผู้ป่วย Stroke ด้วยโรคหลอดเลือดสมองเดิม ภายใน 28 วันโดยไม่ได้วางแผน
        </h1>
      </section>
          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header">
                <h3 class="box-title">
                  <div class="container">
                    <form class="form-inline" method="POST" action="dn0107.php">
...
<div class="row">
  <div class="col-xs-8">
    <div class="box">
      ...
      <div class="box-body table-responsive">
        ...
        <div> a = จำนวนผู้ป่วย Stroke ที่ต้องรับกลับเข้า รพ. ภายใน 28 วัน <span class="pdx"> pdx = I60 , I61 , I62 , I63 , I64 , I65 , I66 , I67 </span></div>
        <div> b = จำนวนผู้ป่วย Stroke ที่จำหน่าย ในเดือนก่อนหน้านั้น <span class="pdx"> pdx = I60 , I61 , I62 , I63 , I64 , I65 , I66 , I67 </span></div>
      </div>
    </div>
  </div>
  ...
  <div class="col-xs-4">
    <div class="box">
      ...
      <button type="" class="btn btn-default pull-right" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModalpdf_dn0107"> นิยาม </button>
          ...
          <tbody>
            ...
            { 
              ...
              <tr class="ho" >
                ...
                <td class="pdx"><?php echo $row_result['lastvisit']; ?></td>
