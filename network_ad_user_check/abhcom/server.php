...
$sql_dep = "SELECT a.*,COUNT(*) AS com_total
FROM com_dep as a
INNER JOIN com_detail as b ON a.dep_id = b.com_depid
GROUP BY a.dep_id
                ...
                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                  <thead>
                    <tr class="btn-primary ">
                      <th class="text-center">ข้อมูล(เครื่อง)</th>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr class="table-hover">
                        <td class="text-center"><button class="btn btn-success btn-circle btn-sm " data-toggle="modal" data-target="#myModal<?php echo $row['dep_id']; ?>"><?php echo $row['com_total']; ?></button></td>
                        <td class="text-center"><button class="btn btn-danger btn-circle btn-sm " data-toggle="modal" data-target="#my_ma<?php echo $row['dep_id']; ?>"><i class="fas fa-exclamation-triangle"></i></button></td>
                      ...
                      <!-- Modal Detail -->
                      <div id="myModal<?php echo $row['dep_id']; ?>" class="modal fade" role="dialog">
                        <div class="modal-dialog modal-xl">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              ?>
                                <a href="#" data-tooltip="<?php echo "Note : ".$row_detail['com_name']." ".$row_detail['com_note']; ?>">
                                <div class="row row-body" > 
                                  <div class="col-lg-3"><?php echo $row_detail['com_code']; ?></div>
                                  <div class="col-lg-1"><?php echo $row_detail['com_type']; ?></div>
                                  <div class="col-lg-2"><?php echo $row_detail['com_os_m']; ?></div>
                                  <div class="col-lg-1"><?php echo $row_detail['com_cpu_m']; ?></div>
                                  <div class="col-lg-1"><?php echo $row_detail['com_ram_m']; ?></div>
                                  <div class="col-lg-1"><?php echo $row_detail['com_hdd_m']; ?></div>
