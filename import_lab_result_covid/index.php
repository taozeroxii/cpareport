...
<body>
    <div class="container-fulid" style="padding:50px">
        ...
        <p>*************************************************************************************************************************************************************</p>
        <p style="color:red">**โปรดเลือกไฟล์อัพโหลดที่ถูกต้องและข้อมูลไม่เยอะเกิน 30 วินาทีจากการ update **</p>
        <p style="color:green">**การ Update Data จะอิงจากไฟล์ล่าสุดที่ทำการ upload ขึ้น server ไว้ ข้อมูลจะเข้าตาม vn_lab ที่ไม่ซ้ำกัน**</p>
    </div>
    <script>
        function myFunction() {
