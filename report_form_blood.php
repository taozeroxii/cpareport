      ...
      <div class="col-xs-12">
        <div class="box">
         ...
         <?php
          ...
          else if($_GET['sql']  == 'sql_0251' ||$_GET['sql'] == 'sql_0252'){ echo '<span class="fcol">IPD</span>'; }
...
<script type="text/javascript">
		...
		{
			document.location = "export_excel_f001.php?send_excel=<?php echo $send_excel; ?>&datepickers=<?php echo $datepickers; ?>&datepickert=<?php echo $datepickert; ?>&l_dropdown=<?php echo  $sum_r  ;?>";
		}
  </script>
